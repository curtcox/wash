...
- R7 is the one genuinely unaddressed gap (no spec text covers it yet); the
  others are explicit v1 "reserved / out of scope" boundaries already documented
  in the specs and repeated here for tracking.
